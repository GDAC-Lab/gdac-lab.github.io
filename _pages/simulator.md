...
The simulator pairs a MuJoCo physics process (Python) with controllers connected over UDP (MATLAB or Python). It supports single and multiple vehicles, walls and curved terrain, and hardware-in-the-loop (HITL) runs with a real PX4 flight controller.
...
- Citation: use the `CITATION.cff` file in the repository
